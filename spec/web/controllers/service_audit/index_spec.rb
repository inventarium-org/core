...
RSpec.describe Web::Controllers::ServiceAudit::Index, type: :action do
  ...
  context 'when user authenticated' do
    ...
    context 'and organisation_operation returns success result' do
      ...
      context 'and service operation returns success result' do
        ...
        context 'and audit_operation returns success result' do
        ...
        context 'and audit_operation returns failure result' do
